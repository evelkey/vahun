...
def main(args=None):
    ...
    testcorp=Corpus(corpus_path=args.corp_path,language="Hun",size=dictsize,encoding_len=args.feature_len,corpus_stream=args.infile,printer=False)
    testdata=corp.featurize_data_charlevel_onehot(corp.mark_list(corp.hun_lower_unique))
    ...
    show_reconstruction(encoder,x_train,corp,length=0)
...
if __name__ == '__main__':
    ...
    parser.add_argument("--pop_size", dest="pop_size", default=20, type=int, help="Population size")
